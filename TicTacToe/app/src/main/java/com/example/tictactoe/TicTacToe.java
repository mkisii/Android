...
//    Dimensions of the TicTacToeBoard
    @Override
...
//    Drawing the line on the winning side horizontal
    private void drawHorizontalLine(Canvas canvas, int row, int col){
        canvas.drawLine(col, row*cellSize + cellSize/2,
                cellSize*3, row*cellSize + cellSize/2,
                paint);
    }
       //    Drawing the line on the winning side Vertical
    ...
    //    Drawing the line on the winning side Diagonal Positive
